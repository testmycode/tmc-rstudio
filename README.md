...
2. Next, either:
   ...
   ii. Alternatively, on the terminal, navigate to the folder where `tmcrstudioaddin_0.8.4.tar.gz` is located,
   and run the command `R CMD INSTALL tmcrstudioaddin_0.8.4.tar.gz`. You still
