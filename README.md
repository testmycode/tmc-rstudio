...
or
	ii. On the terminal, navigate to the folder where tmcrstudioaddin_0.2.1.tar.gz is located, and run the command "R CMD INSTALL tmcrstudioaddin_0.2.1.tar.gz"

3. Once the package tmcrstudioaddin is installed, open RStudio and select "Addins" from upper bar and there "TMC R 0.2".
